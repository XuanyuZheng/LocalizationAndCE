function [cord_fixed_est,h_est,h_est_2] = loc_SRED_SPI_ign_PHN(y,SNRs_LoS,SNRs_NLoS,PHN_deg,PHN_CovMat,P)
...
%     v_tilde_est = zeros(2*P.N*P.M,1);
    ...
    % covariance matrix
    W_y = eye(2*P.N*P.Nr) + 1/sqrt(noise_power) * D_y_tilde * 2*deg2rad(0) * D_y_tilde.';
    % W_y^(-1/2)
